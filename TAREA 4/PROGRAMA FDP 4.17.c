...
/* Lluvias.
El programa permite calcular el promedio mensual de las lluvias caidas en tres regiones importantes del pais. Determina tambien cual es la region con mayor
...
/* Esta funcion obtien la region con mayor promedio de lluvia anual. */
{
    if (R1 > R2)
        if (R1 > R3)
