...
typedef struct
{
    ...
    matpro cal[5];  /* Arreglo de estructura matpro. */
} alumno;
...
/* Lee la informacion de un arreglo unidimensional de tipo alumno. */
{
    int I, J;
...
/* Obtiene la matricula y el promedio general de cada alumno. */
{
    int I, J;
    float SUM;
...
/* Imprime matriculas de alumnos con promedio > 9 en tercera materia. */
{
    int I;
