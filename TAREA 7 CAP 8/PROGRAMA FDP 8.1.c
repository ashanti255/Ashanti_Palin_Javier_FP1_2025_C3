...
void main(void)
{
    ...
    /* Los campos de a2 reciben valores por medio de lectura. */
    ...
    /* Los campos de a3 reciben valores por asignacion. */
    ...
    /* Otra forma de imprimir los campos de a3. */
    printf("\nDatos del alumno 3\n");
    printf("%d \t %s \t %s \t %.2f \t %s",
