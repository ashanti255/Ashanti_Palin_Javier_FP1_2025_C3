...
typedef struct
{
    ...
    char sexo;
    int con;        /* Condición. */
    domicilio dom;  /* Campo de tipo estructura domicilio. */
...
/* Lectura de un arreglo unidimensional de tipo paciente. */
{
    int I;
...
/* Porcentaje de hombres y mujeres registrados en el hospital. */
{
...
/* Número de pacientes por categoría de condición. */
{
...
/* Nombre y teléfono de pacientes en condición 5. */
{
    int I;
