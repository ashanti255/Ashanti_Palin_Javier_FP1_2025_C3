...
void main(void)
{
    ...
    a un valos de tipo entero. Si la cadena comienza con otro caracter o no
    ...
    gets(cad0);
    d = atof(cad0);
    /* La funcion atof convierte una cadena de caractteres que contiene numeros
    ...
    un valor de tipo long. Si la cadena no contiene numeros o comineza con
    otro caracter, regresa 0 o el valor queda indefinido. */
    printf("\n%s \t %ld ", cad0, 1+10);

    l = strtol(cad0, &cad1, 0);
    /* La funcion strtol convierte una cadena de carcateres que contiene numeros a
