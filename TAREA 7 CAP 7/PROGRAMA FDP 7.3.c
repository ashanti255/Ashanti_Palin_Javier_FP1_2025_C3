...
void main(void)
{
    char * cad0 = "Buenos dias";  /* En este paso se asignan 11 caracteres mas el
    caracter de terminacion '\0' a la posicion de memoria a la que apunta la
    variable cad0 -apuntador del tipo cadena de carcteres. */
    ...
    el carcater de terminacion) a la variable cad2. Obseva que cad2 no tiene espacio
    ...
    queremos ingresar la cadena "BUneos dias", solo lee la palabra "Buenos", por
    ...
    printf("\Ingrese uan linea de texto -se lee cada caracter con getchar -: \n");
