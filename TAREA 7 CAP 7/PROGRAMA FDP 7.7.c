...
void main(void)
{
    int i;char cad0[20] = "Hola Mexico";
    ...
    regresa un valor positivo; si es menor, un valor negativo y otra forma, 0. */
    ...
    un apuntador a la primera ocurrencia del acracter en la cadena, de otra
    forma regresa NULL. */
    if (c != NULL)
    {
